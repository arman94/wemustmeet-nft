...
export const BidHistory = ({ items }) => {
  ...
  useLayoutEffect(() => {
    ...
    xAxisTooltip.dy = 5
    xAxisTooltip.label.fill = am4core.color("#00ebff")
    ...
    xAxisTooltipShadow.color = am4core.color("#00ebff")
    ...
    yAxisTooltip.dy = 5
    yAxisTooltip.label.fill = am4core.color("#00ebff")
    ...
    yAxisTooltipShadow.color = am4core.color("#00ebff")
    ...
    function createSeries(field, name) {
      ...
      series.tooltip.background.fill = am4core.color("#ff39b0")
      ...
      tooltipShadow.color = am4core.color("#00ebff")

      const bullet = series.bullets.push(new am4charts.CircleBullet())
      bullet.circle.stroke = am4core.color("#fff")
      bullet.circle.fill = am4core.color("#ff39b0")
